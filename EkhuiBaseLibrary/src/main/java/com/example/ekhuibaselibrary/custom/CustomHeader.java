...
public class CustomHeader extends InternalClassics<CustomHeader> implements RefreshHeader {
...
//    public static String REFRESH_HEADER_UPDATE = "'Last update' M-d HH:mm";
    ...
    public CustomHeader setLastUpdateTime(Date time) {
        final View thisView = this;
        mLastTime = time;
    ...
    public CustomHeader setTimeFormat(DateFormat format) {
    ...
    public CustomHeader setLastUpdateText(CharSequence text) {
        mLastTime = null;
        mLastUpdateText.setText(text);
        return this;
    }

    public CustomHeader setAccentColor(@ColorInt int accentColor) {
        mLastUpdateText.setTextColor(accentColor & 0x00ffffff | 0xcc000000);
        return super.setAccentColor(accentColor);
    }

    public CustomHeader setEnableLastTime(boolean enable) {
        final View updateView = mLastUpdateText;
    ...
    public CustomHeader setTextSizeTime(float size) {
...
//    }
    ...
    public CustomHeader setTextTimeMarginTop(float dp) {
        final View updateView = mLastUpdateText;
