...
public class PieProgressView extends View {
    ...
    public PieProgressView(Context context, AttributeSet attrs, int defStyle) {
        ...
        max = mTypedArray.getInteger(R.styleable.PieProgressView_srp_max, 100);
        style = mTypedArray.getInt(R.styleable.PieProgressView_srp_style, 0);
        startAngle = mTypedArray.getInt(R.styleable.PieProgressView_srp_startAngle, 90);
