package com.example.ekhuibaselibrary.itemDecoration;
...
public class RecycleLineDivider extends RecyclerView.ItemDecoration {
     ...
     */
    public RecycleLineDivider(Context context, int orientation) {
     ...
     */
    public RecycleLineDivider(Context context, int orientation, int drawableId) {
     ...
     */
    public RecycleLineDivider(Context context, int orientation, int dividerHeight, int dividerColor) {
        this(context, orientation);
